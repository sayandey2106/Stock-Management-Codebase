                                ...
                                <Dialog open={this.state.update} onClose={() => {
                                    ...
                                    <DialogActions>
                                        ...
                                        <Button
                                            onClick={() => {
                                                this.handleClose();
                                                update_client(this.state.id, this.state.name, this.state.profile, this.state.email, this.state.password, this.state.position, this.state.department, this.state.employee_id, login.token, login.organization_id)
                                            }}
                                            color="primary"
                                        >
                                            Update
