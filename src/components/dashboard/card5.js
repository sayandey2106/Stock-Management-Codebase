...
const App5 = () => {
    ...
    const front = (
      ...
      <CardActionArea>
        <CardMedia
          ...
          alt="Consumption/Day"
          height="350"
          image="https://cdn.pixabay.com/photo/2017/05/15/11/07/coffee-cup-2314535__340.jpg" style={{height:350}}
    ...
    return (
        <div style={{padding: 5, position: "absolute",marginTop:520,marginLeft:383}}>
