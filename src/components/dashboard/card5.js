...
const App5 = () => {
    ...
    const front = (
      ...
      <CardActionArea>
        <CardMedia
          ...
          alt="Consumption/Day"
          height="350"
          image="https://cdn.pixabay.com/photo/2017/05/15/11/07/coffee-cup-2314535__340.jpg" style={{height:"34vh"}}
          title="Consumption/Day"
        />
        <CardContent>
          <Typography gutterBottom variant="h5" component="h2">
       
         <center style={{ fontFamily: 'Orbitron',fontWeight:1000,color:"#131327"}}>Consumption/Day</center>
    ...
    return (
        <div style={{padding: 5, position: "absolute",marginTop:"52vh",marginLeft:"25.7vw"}}>
