...
const App6 = () => {
    ...
    const front = (
      ...
      <CardActionArea>
        <CardMedia
          ...
          height="350"
          image="https://cdn.pixabay.com/photo/2019/11/11/15/32/coffee-4618705__340.jpg" style={{height:350}}
    ...
    return (
        <div style={{padding: 5, position: "absolute",marginTop:520,marginLeft:738}}>
