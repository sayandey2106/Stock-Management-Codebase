            ...
            <Grid container justify="center">
                <Grid item xs={12}>
                    <Card style={card}>
                        ...
                        <CardContent>
                            <Grid item lg={12}>
                                <Link to="add_manager" style={{textDecoration: "none"}}>
                                    <IconButton>
                                        <Icon>add</Icon>
                                    </IconButton>
                                </Link>
                            ...
                            <Table>
                                ...
                                <Dialog open={this.state.delete}
                                    ...
                                    <DialogTitle id="form-dialog-title">Delete Manager</DialogTitle>
                                    <DialogContent>
                                        <DialogContentText>
                                            Are you sure?
                                        </DialogContentText>
                                    ...
                                    <DialogActions>
                                        ...
                                        <Button
                                            onClick={() => {
                                                this.handleClose();
                                                delete_manager(this.state.id, login.token, login.organization_id)
                                            }}
                                            color="primary"
                                        >
                                            Yes
...
export default withStyles(styles)(ManagerComponents);